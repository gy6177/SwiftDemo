...
public class ZCycleView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        collectionView.frame = CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height - 25)
        pageControl.frame = CGRect(x: 0, y: frame.size.height-15, width: frame.size.width, height: 15)
        collectionView.setContentOffset(.zero, animated: false)
        dealFirstPage()
